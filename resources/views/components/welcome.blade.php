<div
     class="p-6 bg-white border-b border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent lg:p-8">
...
<div class="grid grid-cols-1 gap-6 p-6 bg-gray-200 bg-opacity-25 dark:bg-gray-800 md:grid-cols-2 lg:gap-8 lg:p-8">
  <div>
    <div class="flex items-center">
      <svg class="w-6 h-6 stroke-gray-400"
    ...
    <p class="mt-4 text-sm">
      <a class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300"
        ...
        <svg class="w-5 h-5 ms-1 fill-indigo-500 dark:fill-indigo-200"
             xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 20 20">
